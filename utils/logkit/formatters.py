...
class JSONLogFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if "created" in dict_record:
            # sobrescreve metodo formatTime para retornar datetime com timezone
